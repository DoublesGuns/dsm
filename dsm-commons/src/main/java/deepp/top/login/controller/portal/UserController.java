package deepp.top.login.controller.portal;
...
//重置密码
    ...
    @ResponseBody
    public ServerResponse<String> forgetRestPassword(String username,String passwordNew,String forgerToken){
        return iUserService.forgetRestPassword(username, passwordNew, forgerToken);
    }
    //登录状态重置密码
